...
// [Guard]
#ifndef _B2D_TEXT_OTPLATFORM_P_H
#define _B2D_TEXT_OTPLATFORM_P_H
...
namespace Platform {
  ...
  enum PlatformId : uint32_t {
    ...
    kPlatformISO                           = 2,  //!< ISO platform id (deprecated).
    kPlatformWindows                       = 3,  //!< Windows (MS) platform.
    kPlatformCustom                        = 4   //!< Custom ('name' table).
  };
...
// [Guard]
#endif // _B2D_TEXT_OTPLATFORM_P_H
