...
// ============================================================================
// [b2d::Gradient - Interpolate (AVX2)]
// ============================================================================

static void B2D_CDECL Gradient_interpolate32_AVX2(uint32_t* dPtr, uint32_t dWidth, const GradientStop* sPtr, size_t sSize) noexcept {
...
// ============================================================================
// [b2d::Gradient - Init / Fini (AVX2)]
// ============================================================================

void GradientOnInitAVX2(GradientOps& ops) noexcept {
  ops.interpolate32 = Gradient_interpolate32_AVX2;
}

B2D_END_NAMESPACE

// [Guard]
#endif // B2D_BUILD_AVX2
