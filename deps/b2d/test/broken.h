...
#define INFO(...) (void)(::BrokenAPI::setContext(__FILE__, __LINE__) && ::BrokenAPI::info(__VA_ARGS__))

//! #define INFO(EXP [, FORMAT [, ...]])
//!
//! Expect `EXP` to be true or evaluates to true, fail otherwise.
#define EXPECT(...) (void)(::BrokenAPI::setContext(__FILE__, __LINE__) && ::BrokenAPI::expect(__VA_ARGS__))
